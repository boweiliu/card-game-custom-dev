...
export type PendingMessageID = (string | number) & { __pending_message_id: true };
...
export class IDGenerator {
   ...
   */
  static validatePrefix<T extends IDPrefix>(id: string, expectedPrefix: T): id is PrefixedId<T> {
   ...
   */
  static fromLegacyId<T extends IDPrefix>(numericId: number, prefix: T): PrefixedId<T> {
